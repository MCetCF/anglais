...
\begin{frame}
	...
	\item<4-> Imposture aren't easy to make
          % difficult to pretend to be someone else, require a good accent.
    \end{itemize}
\end{frame}
% ------------------------------------------------------------------------------------------------
...
\begin{frame}
    ...
    % Again as Eric said, in 1942, 29 Navajos were recuit to create a code because
    % of a lack of military terms in the language
