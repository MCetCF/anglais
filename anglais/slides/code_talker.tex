...
\begin{frame}
      \frametitle{Plan}
    We speak of the Navajo code talkers who are the best known
...
\begin{frame}
    \frametitle{Boarding schools}
     ...
     At the beginning of the 20th century, many American Indian children were in 
	...
	\item drop their traditional native names and take English ones 
...
\begin{frame}
    ...
    September 1918: During the Second Battle of the Somme 

	\begin{itemize}
		\item They helped to win the battle.
...
\begin{frame}
	...
	% As Eric said, this method was..
	\item<1-> faster than any machine at this time.

	% Recruitement is possible
	\item<2-> The largest population of Native American 
		%so the possibility to recruit and
	        %form enough code talkers

	%An obscure langage:
	\item<3-> Only a handful of non Navajo experts were
	...
	\item<4-> Extremely difficult to distinguish for uninitiated Navajo Speakers
	\item<4-> Imposture aren't easy to make: it requires to speak Navajo with a good accent.
    \end{itemize}
\end{frame}
% ------------------------------------------------------------------------------------------------
...
\begin{frame}
	...
	\item<1-> Kerckhoffs's principles aren't observed
		% If a code talker is caught by the ennemy, the message..
...
But..
    \begin{itemize}
	    \item Poor conditions life (A VERIFIER)
