...
\begin{frame}
    ...
    \pause
    \begin{itemize} 
	\item The journey lasts 18 days
...
\begin{frame}
    \frametitle{Boarding schools}
     ...
     At the begin of the 20th century, many American Indian children were in 
...
\begin{frame}
    ...
    \begin{quote}
	They tell us not to speak in Navajo language. You are going to school.
	You are supposed to only speak English. And it was true. They did practice
...
\begin{frame}
    ...
    September 1980: During the Second Battle of the Somme 

	\begin{itemize}
		\item Germans tapped into American's telephone lines  and
	broke their codes. 
\item Captain Lawrence of the US Army heard two Choctaw talking in their own
	    language. This give him the idea to use them
	    to transmit secret tactical messages in their native language.
		\item They created a code of 20 terms.
		\item They helped to win the battle.
	\end{itemize}

    \pause
    After the WWI,  Germany send students and
...
\end{quote}
	...
	\begin{itemize}
	\item
		They also served during the Korean War and 
the begin of the Vietnam War.
\pause
...
\begin{frame}
	...
	\item<3-> Navajos trained at different times and places so they
		develop differents evolutions of the code.
